Locales['fr'] = {
  ...
  -- Inventory Menu
  ['inventory_title'] = 'Gestion Inventaire',
  ...
  -- Bills Menu
  ['bills_title'] = 'Gestion Factures',

  -- Clothes Menu
  ['clothes_title'] = 'Vos Vêtements',
  ['clothes_top'] = ' Haut',
  ['clothes_pants'] = ' Bas',
  ...
  ['bossmanagement_title'] = '~b~Gestion Entreprise: %s',
  ...
  -- Admin Menu
  ['admin_title'] = '~r~Staff - Administration',
